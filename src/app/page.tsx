  ...
  return (
    <div className="bg-black text-[#fafafa]">
      ...
      <div className="relative border-b border-white/5">
        ...
        <section className="max-w-4xl mx-auto px-6 pt-20 md:pt-28 pb-16 text-center relative z-10">
          ...
          <p className="font-mono text-sm uppercase tracking-[0.3em] text-[#a1a1aa] mb-8 drop-shadow-md">Data over denial &middot; Starve the virus</p>
          <p className="text-lg text-[#a1a1aa] leading-relaxed max-w-2xl mx-auto mb-10 drop-shadow-md">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            ...
            <a href={AAFIENDS} className="inline-flex items-center gap-2 border border-[#27272a] hover:border-[#10b981] text-[#fafafa] font-black uppercase tracking-widest text-xs px-6 py-4 rounded-lg bg-black/50 backdrop-blur transition-colors">
      ...
      <section className="max-w-5xl mx-auto px-6 py-12">
        <div className="bg-[#09090b] border border-[#27272a] rounded-2xl relative overflow-hidden flex flex-col md:flex-row items-center gap-6 justify-between">
          ...
          <div className="p-8 relative z-10 flex flex-col md:flex-row items-center gap-6 justify-between w-full">
            ...
            <Link href="/trench" className="shrink-0 inline-flex items-center gap-2 border border-[#27272a] hover:border-[#dc2626] bg-black/50 backdrop-blur text-[#fafafa] font-black uppercase tracking-widest text-xs px-6 py-4 rounded-lg transition-colors">Open the repository &rarr;</Link>
          </div>
        </div>
      </section>
...
And track my daily habits just to hold the baseline fine.</pre>
      ...
      <section className="w-full relative py-24 flex items-center justify-center border-y border-white/5 my-12">
        ...
        <div className="relative z-10 text-center px-6">
          <h2 className="text-3xl md:text-5xl font-black text-white tracking-tight uppercase drop-shadow-xl">
            STAY ON <span className="text-[#10b981]">THE GRID.</span>
          </h2>
          <p className="text-sm font-mono text-[#a1a1aa] mt-4 uppercase tracking-widest drop-shadow-lg">
            Isolation is a symptom. Connection is the cure.
          </p>
        </div>
      </section>
